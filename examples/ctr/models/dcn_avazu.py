...
def dcn_avazu(
    dense_input, sparse_input, y_, embedding_size=128, enable_push_index=False
):
    ...
    sparse_input = ht.array_reshape_op(sparse_input, (-1, 18 * embedding_size))
    ...
    # DNN
    flatten = x
    W1 = init.random_normal([18 * embedding_size + 4, 64], stddev=0.01, name="W1")
    W2 = init.random_normal([64, 32], stddev=0.01, name="W2")
    W3 = init.random_normal([32, 16], stddev=0.01, name="W3")

    W4 = init.random_normal([16 + 18 * embedding_size + 4, 1], stddev=0.01, name="W4")
