...
def dfm_avazu(dense_input, sparse_input, y_, embeding_size=128, enable_push_index=False):
    ...
    # DNN
    flatten = ht.array_reshape_op(sparse_2dim_input, (-1, 18*embedding_size))
    W1 = init.random_normal([18*embedding_size, 64], stddev=0.01, name="W1")
    W2 = init.random_normal([64, 32], stddev=0.01, name="W2")
    W3 = init.random_normal([32, 1], stddev=0.01, name="W3")
