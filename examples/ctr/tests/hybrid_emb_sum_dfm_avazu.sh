...
# heturun -s 1 -w 2 python ${mainpy} --model dfm_criteo --val --comm Hybrid --cache lfuopt --bound 3
heturun -s 1 -w 2 python ${mainpy} --model emb_sum_dfm_avazu --val --comm Hybrid --cache lfu --bound 0 --bsp 0 --nepoch 1 --all