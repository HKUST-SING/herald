...
PYBIND11_MODULE(hetu_cache, m) {
    ...
    py::class_<CacheBase>(m, "CacheBase")
        ...
        .def("embedding_update_with_push_keys", &CacheBase::embeddingUpdateWithPushKeys)
        .def("embedding_update_with_push_keys_np_raw", &CacheBase::embeddingUpdateWithPushKeysNpRaw)
        .def("embedding_update_with_push_keys_raw", &CacheBase::embeddingUpdateWithPushKeysRaw)
