...
// Array2D results;
using local_dist_t = py::array_t<elem_t>;
using local_comm_plan_t = vector<vector<elem_t>>;
using queue_element_t = std::variant<local_comm_plan_t, local_dist_t, vector<elem_t>>;
